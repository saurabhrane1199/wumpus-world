package guitrial;
	...
	public class Wumpu extends JPanel implements Runnable
	{
	   /* int[][] rooms = {{334, 20}, {609, 220}, {499, 540}, {169, 540}, {62, 220},
	    ...
	    int[][] rooms = {{100,100}, {200, 100}, {300,100}, {400,100}, {500,100},
	            {100, 200}, {200, 200}, {300, 200}, {400, 200}, {500, 200}, {100, 300},
	            {200, 300}, {300, 300}, {400, 300}, {500, 300}, {100, 400}, {200, 400},
	            {300, 400}, {400, 400}, {500, 400},{100, 500}, {200, 500},
	            {300, 500}, {400, 500}, {500, 500}};

	    int[][] links = {{1,5,-1,-1}, {0,2,6,-1}, {1,3,7,-1}, {2,4,8,-1}, {3,9,-1,-1},
	            {0, 6, 10}, {1,5,7,11}, {2,6,8,12}, {3,7,9,13}, {4,8,14,-1}, {5, 11 ,15,-1},
	            {6,10,12,16}, {7,11,13,17}, {8,12,14,18}, {9,13,19,-1}, {10, 16, 20,-1},
	            {11, 15,17,21}, {12, 16, 18,22}, {13,17,19,23}, {14,18,24,-1},{15, 21, -1,-1},{16, 20,22,-1},
	            {17, 21, 23,-1},{18, 22, 24,-1},{19,23,-1,-1}};
		...
		public void run() {
			invokeLater(() ->{
	            ...
	            f.setTitle("Find The Wumpus");
	            f.setResizable(false);
	            f.add(new Wumpu(), BorderLayout.CENTER);
	            f.pack();
